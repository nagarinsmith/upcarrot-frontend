...
import {VictoryChart, VictoryStack, VictoryArea, VictoryTheme,VictoryLegend}  from "victory";
        ...
        eventHandlers: {
            ...
            onMouseOut: () => {
                return [
                    ...
                    childName: "area-1",
                    target: "data",            
                    mutation: (props) => ({ style: Object.assign({}, props.style, { fill: "#262626" }) })
                    },
                    {
                    childName: "area-2",
                    target: "data",
                    mutation: (props) => ({ style: Object.assign({}, props.style, { fill: "#404040" }) })
                    },
                     {
                    childName: "area-3",
                    target: "data",
                    mutation: (props) => ({ style: Object.assign({}, props.style, { fill: "#808080" }) })
                    }, 
                    {
                    childName: "area-4",
                    target: "data",
